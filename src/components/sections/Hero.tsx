  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-crema">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute right-0 top-0 w-1/2 h-full bg-gris-suave/60 clip-hero" />
        <div className="absolute right-0 top-0 w-[2px] h-full bg-dorado/20" style={{ right: "50%" }} />
      </div>

      {/* Decorative lines */}
      <div className="absolute left-0 top-1/4 w-[1px] h-32 bg-dorado/30 ml-8" />
      <div className="absolute left-0 top-1/4 w-6 h-[1px] bg-dorado/30 ml-8 mt-16" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            <motion.p
              ...
              animate="visible"
              variants={fadeUp}
              className="font-sans text-xs font-semibold tracking-widest uppercase text-dorado mb-6"
            >
            ...
            <motion.h1
              ...
              animate="visible"
              variants={fadeUp}
              className="font-serif text-5xl lg:text-6xl xl:text-7xl font-semibold text-azul leading-[1.05] mb-6"
            >
              Soluciones{" "}
            ...
            <motion.p
              ...
              animate="visible"
              variants={fadeUp}
              className="font-sans text-base lg:text-lg text-gris-texto/80 leading-relaxed max-w-lg mb-10"
            >
            ...
            >
              ...
              <Link
                href="/servicios"
                className="inline-flex items-center justify-center gap-2 font-sans font-semibold text-sm border border-azul text-azul px-7 py-4 rounded-sm hover:bg-azul hover:text-white transition-all tracking-wide"
              >
                Ver servicios
              </Link>
            </motion.div>
      ...
      <motion.div
        ...
        className="relative bg-azul py-4"
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-2">
            {ESPECIALIDADES.map((esp, i) => (
              <span
                key={esp}
                className="font-sans text-xs font-medium text-white/80 tracking-widest uppercase flex items-center gap-4"
              >
                {esp}
      ...
      <motion.div
        ...
        className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-azul/40"
        style={{ bottom: "5rem" }}
      >
