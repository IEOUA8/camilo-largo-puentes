...
import { CORREO_CONTACTO, TELEFONO, CIUDAD, WHATSAPP_NUMBER, WHATSAPP_MESSAGE } from "@/lib/constants";

export const metadata: Metadata = {
  title: "Contacto | Camilo Largo Puentes",
  description:
    "Solicite asesoría jurídica especializada en derecho urbanístico, ambiental, avalúos y consultoría inmobiliaria.",
};
      ...
      <div className="bg-azul pt-44 pb-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <p className="font-sans text-base text-white/70 mt-4 max-w-xl leading-relaxed">
            ...
            jurídica, técnica o territorial para su necesidad.
          </p>
            ...
            <div className="lg:col-span-3">
              <div className="bg-white border border-gris-suave rounded-sm p-8">
                ...
                <p className="font-sans text-sm text-gris-texto/60 mb-8">
                  Diligencie el formulario y nos comunicaremos con usted a la brevedad.
                </p>
                <ContactForm />
              </div>
            </div>
                      ...
                      <li key={item.label} className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          {item.href ? (
                            <a
                              href={item.href}
                              className="font-sans text-sm font-medium text-azul hover:text-dorado transition-colors"
                            >
                              {item.value}
                            </a>
                          ) : (
